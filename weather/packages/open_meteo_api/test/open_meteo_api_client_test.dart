    ...
    () {
      ...
      group(
        ...
        () {
          ...
          test(
            'throws LocationNonFoundFailure on error response',
            () async {
              final response = MockResponse();
              when(() => response.statusCode).thenReturn(200);
              when(() => response.body).thenReturn('{}');
          ...
          test(
            'throws LocationNotFoundFailure on epty response',
            () async {
              final response = MockResponse();
              when(() => response.statusCode).thenReturn(200);
      ...
      "longitude":-87.65005,
          ...
          group(
            ...
            () {
              ...
              test(
                'returns weather on valod response',
                () async {
                  final response = MockResponse();
                  when(() => response.statusCode).thenReturn(200);
                  when(() => response.body).thenReturn(
...
"time": "2022-09-12T01:00"
                  ...
                  expect(
                    actual,
                    isA<Weather>()
                        .having((w) => w.temperature, 'temerature', 15.3)
